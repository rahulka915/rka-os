...
const styles = StyleSheet.create({
  ...
  emptySub: { fontFamily: 'Inter_400Regular', fontSize: 14, fontWeight: '400', textAlign: 'center' },
  ...
  cardTarget: { fontFamily: 'Inter_500Medium', fontSize: 12, fontWeight: '500' },
  lastTime: { fontSize: 12, fontWeight: '500' },
  loggedSet: { fontFamily: 'Inter_500Medium', fontSize: 13, fontWeight: '500' },
